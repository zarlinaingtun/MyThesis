    ...
    <section class="contacts">
            <div class="container-fluid">
                ...
                <div class="text-center">
                    <h1 class="text-muted py-3">Recommendation for Cat Breeds</h1>
                                ...
                                <?php foreach($sizes as $size):?>
                                    <div class="col-4">
                                        <div class="form-check">    
                                            ...
                                            <label class="form-label"><?= ucfirst($size[1])?></label>   
                                        </div>
                                    </div>
                                <?php endforeach;?>
                            </div>   
                                ...
                                <select name="color" id="color" class="form-select selects" required>
                                    <option selected disabled>Choose Color</option>
                                        <?php foreach($colors as $color):?>
                                            <option value="<?= $color[0]?>"><?= ucfirst($color[1])?></option>
                                        <?php endforeach;?>    
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="col-10">   
                                    <select name="coat" id="coat" class="form-select selects" required>
                                        ...
                                        <?php foreach($coats as $coat):?>
                                            <option value="<?= $coat[0]?>"><?= ucfirst($coat[1])?></option>
                                        <?php endforeach;?>    
                                    </select>
                                </div>
                            </div>    
                                ...
                                <?php foreach($childs as $child):?>
                                    <div class="col-4">
                                        <div class="form-check">
                                            ...
                                            <label class="form-label"><?= ucfirst($child[1])?></label>  
                                        </div>
                                    </div>
                                <?php endforeach;?>
                            </div>
                            ...
                            <?php foreach($dogs as $dog):?>
                                <div class="col-4">
                                    <div class="form-check">         
                                        ...
                                        <label class="form-label"><?= ucfirst($dog[1])?></label>
                                    </div>
                                </div>
                            <?php endforeach;?>
                            </div>
